...
(function($) {	
	$(document).ready(function() {
		var breadcrumb = '<a href="<?=site_url()?>/">Home</a><span class="fa fa-angle-double-right">  </span><a href="<?=site_url()?>/testimonials/">Testimonials</a><span class="fa fa-angle-double-right">  </span><h1><?=$term?></h1>';
