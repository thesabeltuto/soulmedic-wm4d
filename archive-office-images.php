...
(function($) {	
	$(document).ready(function() {
		var breadcrumb = '<a href="/">Home</a><span class="fa fa-angle-double-right">  </span><h1>Office Images</h1>';
...
<?php $page_layout 	= dttheme_option('specialty','archives-layout');
	...
	endswitch;?>
      <!-- **Primary Section** -->
      <section id="primary" class="office-images <?php echo $page_layout;?>">
      
		<?php if(get_option('wm4d_office_images') != '' || get_option('wm4d_office_images') != null) { ?>
            <article id="post-office-images" <?php post_class('blog-entry'); ?>>
                <div class="blog-entry-inner">
                	<div class="entry-details">
                        <div class="entry-title"><h4>Office Images</h4></div>
                        <div class="entry-body"><?php echo do_shortcode(get_option('wm4d_office_images')); ?></div>
                    </div>
                </div>
            </article>
        <?php } ?>
